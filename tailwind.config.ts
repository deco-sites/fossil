...
export default {
  ...
  theme: {
    ...
    fontFamily: {
      ...
      gothamBook:["Gotham Book","sans-serif", "Arial", "Helvetica Neue", "Helvetica" ],
      gothamMedium:["Gotham Medium","sans-serif", "Arial", "Helvetica Neue", "Helvetica" ],
      gothamBold:["Gotham Bold","sans-serif", "Arial", "Helvetica Neue", "Helvetica" ],
      museoSans:["Museo Sans"],
      auto:["auto"],
      icomoon:["icomoon","sans-serif", "Arial", "Helvetica Neue", "Helvetica"]
    },
    extend: {
      animation: {
