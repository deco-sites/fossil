...
export default function Utm({ campaignName }: UtmProps, ctx: MatchContext): boolean {
    ...
    const utmCampaign = url.searchParams.get('utmi_pc');
     console.log((utmCampaign !== null && utmCampaign === campaignName) || utmCampaign === 'BuscaFullText')
    return (utmCampaign !== null && utmCampaign === campaignName) || utmCampaign === 'BuscaFullText';
}