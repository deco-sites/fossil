              ...
              {success.value
                ...
                : (
                  <>
                    ...
                    <form
                      class={clx(
                        `flex flex-col items-start justify-center gap-4 relative top-[33%] -translate-y-[33%] md:left-[62px] 
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        class={clx(`
                                                    border-none py-[10px] px-6 rounded-[3px] h-[2.188rem] flex items-center justify-center md:mt-[10px] text-white cursor-pointer 
                                                    font-arial text-[1rem] leading-8 mt-[5px] min-w-[150px] focus:outline-none duration-150 font-light bg-[#969696]`)}
                        disabled={loading}
                      >
                        {form?.button?.label ||
                          "Inscreva-se"}
