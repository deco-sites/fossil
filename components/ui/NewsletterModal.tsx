...
export const loader = (props: Props, req: Request) => {
    ...
    const isOpen = cookieEmpty
        ? false
        : Boolean(!cookies["DecoNewsletterModal"]);
                                    ...
                                    <>
                                        ...
                                        >
                                            ...
                                            <button
                                                type="submit"
                                                class={clx(`
                                                    border-none py-[10px] rounded-[3px] h-[2.188rem] flex items-center justify-center text-white cursor-pointer 
                                            ...
                                            >
                                                ...
                                                >
                                                    Aceito receber ofertas e
                                                    novidades do grupo Technos
                                                </label>
                                            </div>
                                        </form>
                                    </>
