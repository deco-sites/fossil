        ...
        <div class="w-full max-w-7xl m-auto mb-20 lg:mb-28 lg:mt-28">
          ...
          >
            {title &&
              ...
              <p class=" block font-arial text-sm lg:text-18  mt-2 lg:mt-0 tracking-one text-[#1e1d2e]">{description}</p>
          </div>

            <div class="w-full">
                <iframe src="https://munddi.com/fossil?e=1" width="100%" height="500px" allow="geolocation *;"></iframe>
            </div>          
        </div>
    )
}