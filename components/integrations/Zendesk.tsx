const js = () => {
  const init = () => {
    ...
    node.innerHTML =
      ...
      zendBody = document.querySelector('body');
      zendeskChat = zendBody.querySelector('#zendeskChat');

      if (!zendeskChat) {
          zendeskChat = document.createElement('div');
          zendeskChat.id = 'zendeskChat';
          zendBody.appendChild(zendeskChat);
      }

      zendeskChat.addEventListener('click', function() {
