                ...
                <li class="p-6 lg:p-5 flex flex-col">
                  ...
                  <ul class="block mt-4 lg:mt-0">
                    {node.children?.map((leaf) => (
                      <li>
                        <a
                          class="n1-custom-style-navbar--text text-[18px] ![text-shadow:_0_0_0px_#fff] w-full leading-6 uppercase font-medium hover:font-bold text-primary whitespace-nowrap"
                          href={leaf.url}
                        >
